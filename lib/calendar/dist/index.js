...
exports.getMonthMeta = exports.formatResponse = exports.getDaysInMonth = exports.formatDate = exports.months = void 0;
/** Dependencies */
...
/** Constants */
exports.months = dayjs_1.default.months(); // https://day.js.org/docs/en/i18n/listing-months-weekdays
/** Methods */
...
const getMonthMeta = (year) => exports.months.reduce((collector, current) => (0, exports.formatResponse)({ year: String(year), months: exports.months, current, collector }), {});
exports.getMonthMeta = getMonthMeta;
