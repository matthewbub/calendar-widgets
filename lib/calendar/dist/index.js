...
const calendar = (year) => {
    const cal = exports.months.reduce((collector, current) => (0, exports.formatResponse)({ year: String(year), months: exports.months, current, collector }), {});
    return Object.keys(cal).reduce((collector, current) => (Object.assign({ [current.toLowerCase()]: cal[current] }, collector)), {});
};
