...
import './DraggableWeek.styles.css';
import { listHoursBetween, calculateHoursBetween } from '../../helpers';
import { SingleDraggableProps, DraggableContentProps, RowProps, DraggablesProps } from './DraggableWeek.types';
...
const DraggableWeek: FC<DraggablesProps> = ({
  startRow,
  endRow,
  initialDraggables
}) =>
